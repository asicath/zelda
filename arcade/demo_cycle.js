define(['controller/cycle', 'demo_room', 'store_room', 'demo_draw', 'logo', 'controller/load_rooms', 'view/draw'], function(Cycle, DemoRoom, StoreRoom, DemoDraw, Logo, LoadRooms, View) {
