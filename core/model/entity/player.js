define(['../action/actor', '../action/thrust_sword', '../action/switch_alt', './death', '../movement/push', '../movement/walk_controlled', '../movement/mover'], function(Actor, ThrustSword, SwitchAlt, Death, Push, WalkControlled, Mover) {
