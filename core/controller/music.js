define(function() {
    ...
    my.loadAll = function () {
        my.eightBit = new Audio(requirejs.s.contexts._.config.baseUrl + "chains/music/fire_in_the_arese.mp3");
        //my.eightBit = new Audio(baseUrl + "core/assets/music/8 Bit Legend.mp3");
